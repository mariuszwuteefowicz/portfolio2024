...
.then(response => {
    for (let repository of response) {
        ...
        const element = `<article class="rounded-wtf md:rounded-wtf-xl overflow-clip bg-gradient-to-br from-white/10 to-white/5">
        <div class="border-b border-bg h-11 p-4 flex gap-1.5 shadow-innerlight rounded-t-wtf md:rounded-t-wtf-xl bg-gradient-to-br from-white/10 to-white/5">
        ...
        <div class="p-5 md:p-6 lg:p-10">
            ...
            <div class="flex flex-col md:flex-row gap-4 items-start">
                <a href="${homepage}" target="blank" rel="noreferrer nofollow" class="bg-bg text-accent flex gap-3 font-bold py-4 px-5 items-center rounded-wtf md:rounded-xl md:text-xl border-lightGray border-2"><img src="${demoIcon}" class="w-6 h-6" alt=""> View demo</a>
                <a href="${html_url}" target="blank" rel="noreferrer nofollow" class="bg-bg text-accent flex gap-3 font-bold py-4 px-5 items-center rounded-wtf md:rounded-xl md:text-xl border-lightGray border-2"><img src="${githubIcon}" class="w-6 h-6" alt="">Source code</a>
            </div>
        </div>
        </article>`
